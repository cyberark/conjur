Feature: Public keys can be associated with user records.
  ...
  Scenario: 
    ...
    And  I list the public keys for user "alice"
    Then the result is:
    """
     laptop
     workstation
    """
