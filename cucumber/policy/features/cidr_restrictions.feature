...
from a particular network, defined by a CIDR in the policy
  ...
  @acceptance
  Scenario: Removing restricted_to property allows unrestricted access
    Given I load a policy:
    """
    - !user
      id: alice
    ...
    - !host
      id: serviceA
    """
    And I show the user "alice"
    Then the "restricted_to" should be:
    """
      []
    """
    And I show the host "serviceA"
    Then the "restricted_to" should be:
    """
      []
    """
  ...
  @acceptance
  Scenario: Loading policy through POST should preserve existing restricted_to values, not override them.
    Given I load a policy:
    """
    - !user
      id: alice
    ...
    - !user
      id: alice
      restricted_to: 192.168.101.2

    - !host
      id: serviceA
      restricted_to: 192.168.0.2
    """

    And I show the user "alice"
    Then the "restricted_to" should be:
    """
       ["192.168.101.1/32", "192.168.101.2/32"]
    """
