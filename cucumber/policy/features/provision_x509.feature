  ...
  Scenario: Generate a CSR for a store private key
    ...
    - !variable
      ...
      annotations:
        ...
        provision/x509-csr/private-key/variable-id: provisioned/ca/private-key
  ...
  Scenario: Issue a self-signed x509 certificate
    ...
    - !variable
      ...
      annotations:
        ...
        provision/x509-certificate/private-key/variable-id: provisioned/ca/private-key
        provision/x509-certificate/issuer/private-key/variable-id: provisioned/ca/private-key
        provision/x509-certificate/issuer/certificate/self-signed: true
  ...
  Scenario: Issue an x509 certificate from a CA cert
    ...
    - !variable
      ...
      annotations:
        ...
        provision/x509-certificate/private-key/variable-id: provisioned/server/private-key
        provision/x509-certificate/issuer/private-key/variable-id: provisioned/ca/private-key
        provision/x509-certificate/issuer/certificate/variable-id: provisioned/ca/cert
        provision/x509-certificate/ttl: P1D
    """
    When I load the policy into 'root'
