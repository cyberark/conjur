  ...
  module AuthnOidc
    class AuthenticateRequestBody
      ...
      def parsed_id_token(request_body)
        ...
        raise ::Authentication::MissingRequestParam, id_token_field  if
          decoded_id_token_key_value.nil? or
            not decoded_id_token_key_value.include?(id_token_field) or
            not decoded_id_token_key_value.last.present?
