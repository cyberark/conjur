  ...
  module AuthnJwt
    ...
    ValidateAndDecodeToken ||= CommandClass.new(
      dependencies: {
        fetch_signing_key: ::Util::ConcurrencyLimitedCache.new(
          ::Util::RateLimitedCache.new(
            ::Authentication::AuthnJwt::FetchCachedSigningKey.new(
              singing_key_interface: ::Authentication::AuthnJwt::FetchSigningKeyInterface
            ),
        ...
        get_verification_option_by_jwt_claim: ::Authentication::AuthnJwt::GetVerificationOptionByJwtClaim.new,
        logger: Rails.logger
      },
