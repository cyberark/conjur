    ...
    module InputValidation
      ...
      ParseEnforcedClaims = CommandClass.new(
        ...
        def enforced_claims_starts_or_ends_with_delimiter?
          enforced_claims_first_character == AuthnJwt::CLAIMS_CHARACTER_DELIMITER ||
            enforced_claims_last_character == AuthnJwt::CLAIMS_CHARACTER_DELIMITER
        end
        ...
        def enforced_claims_split_by_delimiter
          @enforced_claims_split_by_delimiter ||= @enforced_claims.split(AuthnJwt::CLAIMS_CHARACTER_DELIMITER)
        end
