  ...
  module X509Certificate
    class Provisioner
      ...
      def private_key(resource)
        pkey_var = resource.annotation('provision/x509-certificate/private-key/variable-id')
      ...
      def issuer_certificate(resource)
        ...
        return nil if resource.annotation('provision/x509-certificate/issuer/certificate/self-signed') == 'true'

        cert_var = resource.annotation('provision/x509-certificate/issuer/certificate/variable-id')
      ...
      def issuer_private_key(resource)
        issuer_pkey_var = resource.annotation('provision/x509-certificate/issuer/private-key/variable-id')
