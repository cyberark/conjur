...
describe "AWS Assume Role Dynamic secret input validation" do
  ...
  context "when creating aws assume role dynamic secret with empty role arn" do
    it "then the input validation fails" do
  ...
  context "when creating aws assume role dynamic secret with wrong type role arn" do
    it "then the input validation fails" do
  ...
  context "when creating aws assume role dynamic secret with no role arn" do
    it "then the input validation fails" do
...
describe "AWS Assume Role Dynamic update secret input validation" do
  ...
  context "when updating aws assume role dynamic secret with empty role arn" do
    it "then the input validation fails" do
      method_params = ActionController::Parameters.new(region: "us-east-1", role_arn: "")
      params = ActionController::Parameters.new(branch: "data/dynamic", name:"secret1")
      body_params = ActionController::Parameters.new(ttl: 120, issuer: "issuer1", method_params: method_params)
  ...
  context "when updating aws assume role dynamic secret with wrong type role arn" do
    it "then the input validation fails" do
      method_params = ActionController::Parameters.new(region: "us-east-1", role_arn: 5)
      params = ActionController::Parameters.new(branch: "data/dynamic", name:"secret1")
      body_params = ActionController::Parameters.new(ttl: 120, issuer: "issuer1", method_params: method_params)
  ...
  context "when updating aws assume role dynamic secret with no role arn" do
    it "then the input validation fails" do
      method_params = ActionController::Parameters.new(region: "us-east-1")
      params = ActionController::Parameters.new(branch: "data/dynamic", name:"secret1")
      body_params = ActionController::Parameters.new(ttl: 120, issuer: "issuer1", method_params: method_params)
