...
RSpec.describe Memberships::MembershipService, type: :service do
  ...
  describe '#add_member' do
    # It looks like this test is actually intended to target the controller
    xit 'creates and saves a membership' do
  ...
  describe '#read_member' do
    ...
    # It looks like this test is actually intended to target the controller
    xit 'returns the membership if visible' do
    ...
    # It looks like this test is actually intended to target the controller
    xit 'raises RecordNotFound if not visible' do
      allow(service).to receive(:fetch_member).and_return(membership)
  ...
  describe '#remove_member' do
    ...
    # It looks like this test is actually intended to target the controller
    xit 'raises RecordNotFound if membership does not exist' do
