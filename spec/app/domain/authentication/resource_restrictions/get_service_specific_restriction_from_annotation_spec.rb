...
RSpec.describe(Authentication::ResourceRestrictions::GetServiceSpecificRestrictionsFromAnnotation) do
  ...
  context "GetServiceSpecificRestrictionsFromAnnotation" do
    context "Annotation is general" do
      subject do
        Authentication::ResourceRestrictions::GetServiceSpecificRestrictionsFromAnnotation.new.call(
