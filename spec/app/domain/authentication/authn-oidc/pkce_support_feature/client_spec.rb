...
RSpec.describe(Authentication::AuthnOidc::PkceSupportFeature::Client) do
  ...
  let(:client) do
    VCR.use_cassette("authenticators/authn-oidc/pkce_support_feature/client_load") do
      client = Authentication::AuthnOidc::PkceSupportFeature::Client.new(
  ...
  describe '.callback', :type => 'unit' do
    ...
    context 'when code verifier does not match' do
      it 'raises an error', vcr: 'authenticators/authn-oidc/pkce_support_feature/client_callback-invalid_code_verifier' do
    ...
    context 'when nonce does not match' do
      it 'raises an error', vcr: 'authenticators/authn-oidc/pkce_support_feature/client_callback-valid_oidc_credentials' do
        travel_to(Time.parse("2022-09-30 17:02:17 +0000")) do
          expect do
            client.callback(
              code: '-QGREc_SONbbJIKdbpyYudA13c9PZlgqdxowkf45LOw',
    ...
    context 'when code has previously been used' do
      it 'raise an exception', vcr: 'authenticators/authn-oidc/pkce_support_feature/client_callback-used_code-valid_oidc_credentials' do
        expect do
          client.callback(
            code: '-QGREc_SONbbJIKdbpyYudA13c9PZlgqdxowkf45LOw',
            code_verifier: 'c1de7f1251849accd99d4839d79a637561b1181b909ed7dc1d',
    ...
    context 'when code has expired', vcr: 'authenticators/authn-oidc/pkce_support_feature/client_callback-expired_code-valid_oidc_credentials' do
  ...
  describe '.oidc_client' do
    context 'when credentials are valid' do
      it 'returns a valid oidc client', vcr: 'authenticators/authn-oidc/pkce_support_feature/client_initialization' do
  ...
  describe '.discovery_information', :type => 'unit', vcr: 'authenticators/authn-oidc/pkce_support_feature/discovery_endpoint-valid_oidc_credentials' do
    ...
    context 'when provider URI is invalid', vcr: 'authenticators/authn-oidc/pkce_support_feature/discovery_endpoint-invalid_oidc_provider' do
      it 'returns an timeout error' do
        client = Authentication::AuthnOidc::PkceSupportFeature::Client.new(
          authenticator: Authentication::AuthnOidc::PkceSupportFeature::DataObjects::Authenticator.new(
