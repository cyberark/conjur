...
# NOTES:
#
# We need to be sure to expire the JWT cache before any calls to verify a JWT
# token. The following clears the rails cache before running these specific
# tests. This is mostly helpful for local development.
require 'rake'
Rails.application.load_tasks
Rake::Task['tmp:cache:clear'].invoke

RSpec.describe(Authentication::AuthnJwt::V2::Strategy) do
